...
export function Hero() {
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.trustStrip} aria-label="Chainmail proof points">
        <span>End-to-end encrypted archive</span>
        <span>{"10+"} parsers live</span>
        <span>Koinly-ready CSV</span>
      </div>
      ...
      <div className={styles.preview}>
        <div className={styles.window}>
          <div className={styles.windowBar}>
            ...
            <span className={styles.url}>app.chainmail.app</span>
          </div>
          <div className={styles.windowBody}>
            ...
            <div className={styles.miniList}>
              <div className={styles.miniSearch}>
                <span>Search receipts, tx hashes, assets</span>
                <span className={styles.miniSearchKey}>⌘K</span>
              </div>
              <div className={styles.miniRow} data-unread="true">
                ...
                <div>
                  ...
                  <div className={styles.miniSubject}>Bought 0.5 BTC · parsed as BUY</div>
                </div>
              ...
              <div className={styles.miniRow}>
                ...
                <div>
                  ...
                  <div className={styles.miniSubject}>Deposit 1,000 USDT · CEX</div>
                </div>
            ...
            <div className={styles.receiptPanel}>
              <div className={styles.receiptTop}>
                <span className={styles.receiptStatus}>Encrypted</span>
                <span className={styles.receiptExport}>Export CSV</span>
              </div>
              <div className={styles.receiptTitle}>Parsed receipt</div>
              <div className={styles.receiptSubject}>Coinbase · BTC purchase</div>
              <div className={styles.receiptGrid}>
                <span>Type</span><strong>BUY</strong>
                <span>Asset</span><strong>0.5 BTC</strong>
                <span>Price</span><strong>$32,145.00</strong>
                <span>Total</span><strong>$16,072.50</strong>
              </div>
              <div className={styles.receiptFooter}>Koinly-ready · server cannot read plaintext</div>
            </div>
          </div>
        </div>
      </div>
